...
void PhysicsList::AddPhysicsList(const G4String& name)
{
  ...
  if (name == "emstandard_opt0") {
	...
	fAneutron = new G4AntiNeutronChargeExchangePhysics(5);
  ...
  //  fHadronPhys.push_back( new G4HadronInelasticQBBC(verboseLevel));
	fHadronPhys.push_back( new G4ChargeExchangePhysics(verboseLevel));
  } else if (name  == "chargeexchange"){
